...
<div class="wrap" align="center">
    <form class="form" action="/clients/acsave" method="post">

        <label style="text-transform: uppercase; font-size: 17px"> Заполните поля</label><br><br>

        <label>ID клиента:</label><br>
        <input type="text" id="log" name="login">

        <label >Задать сумму:</label><br>
        <input type="text"  id ="pssw" name="psswd">

        <br><br>
        <input class="submit" type="submit" value="Cоздать">
    </form>
</div>
